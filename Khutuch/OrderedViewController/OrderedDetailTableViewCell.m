...
@implementation OrderedDetailTableViewCell
...
- (UITextView *) aboutTetxView {
    if (!aboutTetxView) {
        aboutTetxView = [[UITextView alloc] initWithFrame:CGRectMake(5, 0, self.contentView.frame.size.width-40, 50)];
...
- (UIButton *) aboutMoreButton {
    if (!aboutMoreButton) {
        aboutMoreButton = [[UIButton alloc] initWithFrame:CGRectMake(self.contentView.frame.size.width - 35, 20, 20, 20)];
...
- (UIView *) cornerView {
    if (!cornerView) {
        cornerView = [[UIView alloc] initWithFrame:CGRectMake(5, 55, self.contentView.frame.size.width-10, 1)];
        cornerView.backgroundColor = [UIColor colorWithWhite:0 alpha:0.5];
    }
    return cornerView;
}
...
{
    ZoxildoxCollectionViewCell *cell=[collectionView dequeueReusableCellWithReuseIdentifier:@"ZoxildoxCollectionViewCell"
...
- (UICollectionView *) zoxitsoxCollectionView {
    if (!zoxitsoxCollectionView) {
        ...
        [zoxitsoxCollectionView registerClass:[ZoxildoxCollectionViewCell class] forCellWithReuseIdentifier:@"ZoxildoxCollectionViewCell"];
        zoxitsoxCollectionView.backgroundColor = UIColor.clearColor;
    }
